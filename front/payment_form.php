...
<div id="wrapper">
  ...
  <div id="display">
    ...
    <form  id="formID" name="invoice" method="post" action="payment_form.php">
    <table width="645">
      <tr>
    ...
    <table  class="displaytb" width="747">
     ...
     <?php
			$result = mysql_query("SELECT * FROM payment_transaction WHERE date_of_entry = CURDATE()");
		while($row = mysql_fetch_array($result)){
			echo "<tr>
			  ...
			  <td width='30'><a href='editentry.php'>Edit</a></td>
			</tr>";
		  }
			?>
            </table>
  ...
  Transactions
            ...
            <li><div class="selected"><a href="payment_form.php">Payment</a></div></li>
