...
<div id="wrapper">
  ...
  <div id="display">
	...
	?> <div id="printer"><a href="../admin/printmeters.php" target="_blank" >Printer Friendly Version</a></div><br /><br />
 ...
 <div id="mainmenu">
  ...
  Transactions
        	<div class="submenu">
            <li> <div class="selected"><a href="../admin/meter_form.php">Meters Entry</a></div></li>
            <li><div class="sublink"><a href="../admin/payment_form_admin.php">Payment</a></div></li>
            <li><div class="sublink"><a href="../admin/cashentry.php">Cash</a></div></li>
             <li><div class="sublink"><a href="#">Invoice Service</a></div></li>
             <li>
               <div class="sublink"><a href="invoice_form.php">Invoice</a></div></li>
            </div>
  Reports
        <div class="submenu">
          <li> <div class="sublink"><a href="#">Customer</a></div></li>
           <li><div class="sublink"><a href="#">Product</a></div></li>
            <li><div class="sublink"><a href="../admin/daily_summary.php">Daily Summary</a></div></li>
             <li><div class="sublink"><a href="#">Sales Summary</a></div></li>
            </div>
  Change
      <div class="submenu">
            <li> <div class="sublink"><a href="../admin/change_price_admin.php">Pump Price</a></div></li>
  ...
  Accounts
        <div class="submenu">
            ...
            <li>
              <div class="sublink"><a href="#">Account Analysis</a></div></li>
    </div>
    </div>
