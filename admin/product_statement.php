...
<title>Query Product Consumption</title>
...
<div id="wrapper">
  ...
  <div id="display">
    <div class="menuhead">Product Statement Options</div><br />
    NOMINAL ACCOUNT ANALYSIS
    <form  id="formID" name="product" method="post" action="product_statements.php">
    <table width="502">
    <tr>   
       <td class="rightalign">Product Account:</td>
        <td>
  ...
  elseif($balancebfd == 1){
    ...
    <table  class='displaytb' width='800'>
        ...
        <tr class='bfd'>
          ...
          <td class='celltb' width='140'><i>Balance BFD</i></td>
          <td class='celltb' width='70'>-</td>
		  ...
		  <td class='right' width='100'>".$bal_bfd_include."</td></tr>";	
